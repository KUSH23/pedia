...
class UserRegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):  
        ...
        user_obj.is_admin = validated_data.get('is_admin')
        user_obj.is_manager = validated_data.get('is_manager')
        user_obj.is_service_manager = validated_data.get('is_service_manager')
        user_obj.save()
        return user_obj
